...
/*************************************************/
/* Commented out:  thermal spectra with chemical potential */
...
/*
	...
	double T_low = param[3];
	double N_low = param[4];

	double low_peak = N_low / (exp(q / T_low) + 1);

	double m0 = param[5];
	double s0 = param[6];
	double n0 = param[7] * 1.e-6;
